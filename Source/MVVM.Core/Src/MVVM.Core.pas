...
type
  ...
  private
    ...
    class procedure SetDefaultBindingStrategy(const AStrategyName: String); static;
  ...
  public
    ...
    class property DefaultBindingStrategy: String read GetDefaultBindingStrategy write SetDefaultBindingStrategy;
  end;
